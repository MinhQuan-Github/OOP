...
ostream &operator <<(ostream &out,const Hocsinh &a){
    cout << setw(20) << a.ht << setw(8) << a.toan << setw(8) << a.van << setw(8) << a.dtb << setw(15) << a.xl << endl;
    return out;
}

bool operator >(const Hocsinh &a1 , const Hocsinh &a2 ){
    if (a1.dtb > a2.dtb) return true;
    return false;
}
...
const Hocsinh &Hocsinh::operator =(const Hocsinh &a1){
    ht = a1.ht;
    toan = a1.toan;
    van = a1.van;
    dtb = a1.dtb;
